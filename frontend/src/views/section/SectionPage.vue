...
<script>
import SectionCreateButton from '@/views/subway.section/components/SectionCreateButton'
import { mapActions, mapGetters, mapMutations } from 'vuex'
import { FETCH_LINE, FETCH_LINES } from '@/store/shared/actionTypes'
import SectionDeleteButton from '@/views/subway.section/components/SectionDeleteButton'
