...
public enum SectionQuery {
    ...
    FIND_BY_LINE_ID("select id, line_id, up_station_id, down_station_id, distance from SECTION where line_id = ?"),
    FIND_BY_STATION_ID("select id, line_id, up_station_id, down_station_id, distance from SECTION where up_station_id = ? or down_station_id = ?"),
