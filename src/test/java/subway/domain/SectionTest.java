...
public class SectionTest {
    ...
    public void getAnotherSectionTest(){
        ...
        assertThatThrownBy(() -> section1.getAnotherSection(section2)).isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(() -> section2.getAnotherSection(section1)).isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(() -> section1.getAnotherSection(section1)).isInstanceOf(IllegalArgumentException.class);
    }
