...
public class StationAcceptanceTest extends AcceptanceTest {
    ...
    @DisplayName("중복된 이름을 가진 지하철 역이 주어지면 지하철 역을 생성할 수 없다.")
    @Test
    ...
    void getStations() {
        // given
        StationResponse stationResponse1 = 지하철_역_등록되어_있음(강남역);
        StationResponse stationResponse2 = 지하철_역_등록되어_있음(역삼역);
        ...
        지하철_역_목록_포함됨(response, Arrays.asList(stationResponse1, stationResponse2));
    }
    ...
    void deleteStation() {
        // given
        StationResponse stationResponse = 지하철_역_등록되어_있음(강남역);

        // when
        ExtractableResponse<Response> response = 지하철_역_제거_요청(stationResponse);
    ...
    public static StationResponse 지하철_역_등록되어_있음(String name) {
        return 지하철_역_생성_요청(name).as(StationResponse.class);
    }
    ...
    public static ExtractableResponse<Response> 지하철_역_제거_요청(StationResponse stationResponse) {
        return RestAssured
                .given().log().all()
    ...
    public static void 지하철_역_생성됨(ExtractableResponse response) {
    ...
    public static void 지하철_역_목록_포함됨(ExtractableResponse<Response> response, List<StationResponse> createdResponses) {
